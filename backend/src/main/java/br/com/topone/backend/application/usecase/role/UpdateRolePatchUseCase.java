...
public class UpdateRolePatchUseCase {

    private final RoleRepository roleRepository;

    @Transactional
    public UpdateRoleResult execute(UpdateRolePatchCommand command) {
        ...
        log.info("Role patched | id={} | name={}", saved.getId(), saved.getName());
